...
highlightListItems();  //run the function 
/* ======================================= */
...
function toggleStatus(e){
    ...
    if(!statusOutput.classList.contains("hidden")){
        ...
        createTimestamp(); //task 8 calling function 
    } else {
...
function createTimestamp(){
    ...
    span.innerHTML= new Date().toLocaleTimeString(); //dynamically adding time each time toggle button being clicked
...
timerButton.addEventListener("dblclick",stopFlashing); //binding to timer Button